class ProductManager {
    ...
    console.log(myProductManager.addProducts( 'CocaCola','Este es un producto prueba', 200, 'Sin imagen', 'abc123', 25));
    console.log(myProductManager.addProducts('Sprite', 'Este es un producto prueba', 200, 'Sin imagen', 'abc123', 25));
    console.log(myProductManager.addProducts( 'Fanta', 200, 'Sin imagen', 'abc1234', 25));
    console.log(myProductManager.getProducts());
